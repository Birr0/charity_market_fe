                    ...
                    <Grid item key={key}>         
                        ...
                        <Grid container item alignItems='center'>
                            <Grid item>
                                ...
                                <Typography variant='h6'>{Object.keys(product).title}</Typography>
                                <Typography>{product.price} GBP</Typography>
                                <Typography>{JSON.stringify(Object.values(product))}</Typography>
                            </Grid>
                            <Grid item>
