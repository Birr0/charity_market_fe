...
import { Button, Typography } from "@material-ui/core";
  ...
  const sugestedSearches = [ //use data from previous searches, product look ats and popular searches 🔥 ...
    ...
    return(
        <Backdrop open={widgetController.backdropState} style={{zIndex:'1', backgroundColor: "#e7e7e7", alignItems:"start"}}>
            <div style={{width:"100%", marginTop:"80px"}}>
                ...
                <Button>Clear searches</Button>
                <Typography>Trending searches</Typography>
                <p>Graphics</p>
            </div>
        </Backdrop>
    );
